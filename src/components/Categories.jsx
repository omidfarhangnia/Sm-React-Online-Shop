...
const Categories = ({ categoryName }) => {
  ...
  useEffect(() => {
    ...
    for (var i = 0; i < filteredItems.length; i++) {
      for (var j = 0; j < filteredItems[i].sizeAndColor.length; j++) {
        for (
          var k = 0;
          k < filteredItems[i].sizeAndColor[j].colors.length;
          k++
        ) {
  ...
  function handleSetFilter() {
    ...
    if (
      ...
      items = items.filter((item) => {
        let priceData = givePriceData(item.price, item.discount.discountValue);
  ...
  return (
    <div>
      <div className="flex flex-wrap justify-between px-5 my-10 md:px-10">
        ...
        <div className="flex w-full flex-wrap justify-between px-5 my-10 md:px-10">
          <div
          ...
          {isFiltered && (
            <form
              className="flex w-full flex-col flex-wrap gap-5 p-5 bg-slate-100 rounded-lg lg:flex-row lg:p-10 lg:mx-10"
              onSubmit={(e) => {
                e.preventDefault();
              }}
            >
              ...
              <div className="flex lg:flex-col lg:w-[30%] flex-wrap justify-between lg:justify-normal gap-5 pb-4 border-b-2 border-b-black border-b-solid lg:border-0">
                ...
                <span>
                  ...
                  />
                  <label
                    className="font-spartan ml-1"
                    htmlFor="price__600__1200"
                  >
                    $600-$1200
                  </label>
                </span>
